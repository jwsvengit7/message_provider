...
public class ProfileController {
    ...
    public ResponseEntity<String> updateProfile(@Validated @RequestBody ProfileRequest profileRequest, @PathVariable("userId")  Long userId, HttpServletRequest httpServletRequest){
    ...
    public ResponseEntity<Profile> getProfileById(@Validated @PathVariable("identityNo")  Long identityNo,HttpServletRequest httpServletRequest){
